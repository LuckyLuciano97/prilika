"""Središnja konfiguracija za Licita pipeline.
...
USER_AGENT = (
    "LicitaBot/1.0 (+https://licita.hr; kontakt: support@nexistudio.dev) "
...
# --- Sadržaj / SEO --------------------------------------------------------
SITE_URL = os.environ.get("LICITA_SITE_URL", "https://licita.hr").rstrip("/")
SITE_NAME = "Licita"
